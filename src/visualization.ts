...
<body>
    ...
    <script>
        ...
        node.append('text').attr('class', 'node-content').attr('y', -4).attr('style', 'font-size:16px;font-weight:700;').text(function(d) { return d.id; });
        node.append('text').attr('class', 'node-content').attr('y', 14).attr('style', 'font-size:10px;font-weight:400;opacity:0.7;text-transform:uppercase;letter-spacing:0.5px;').text(function(d) { return d.type; });
